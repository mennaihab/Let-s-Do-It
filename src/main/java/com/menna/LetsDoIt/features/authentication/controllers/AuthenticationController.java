...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticationResponse> register(@ModelAttribute RegistrationRequest request) throws Exception {
        return ResponseEntity.ok().body(authenticationService.register(request));
    }

    @PostMapping("/login")
    public ResponseEntity<AuthenticationResponse> login(@ModelAttribute LoginRequest request) {
